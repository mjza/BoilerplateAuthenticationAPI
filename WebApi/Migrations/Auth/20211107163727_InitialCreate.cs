    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "AuthDBO",
                table: "accounts",
                columns: new[] { "id", "accept_terms", "birthday", "created_at", "email", "first_name", "gender_id", "last_name", "nationality_id", "number", "password_hash", "password_reseted_at", "postcode", "profession_id", "reset_token", "reset_token_expires_at", "role", "settings", "street", "title_id", "updated_at", "verification_token", "verified_at" },
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), true, new DateTime(1985, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 12, 30, 9, 10, 30, 0, DateTimeKind.Unspecified), "super1@gmail.com", "Super", "m", "1", "de", "137a", "$2a$11$4SCtOwrKu7yiigd3FO7dsOFNhKqYhhYsZFATQA.zFTMFLMZaLf0aq", null, "50825", new Guid("54a130d2-502f-4cf1-a376-63edeb000003"), null, null, 0, "{}", "Bonnstr.", "mr", null, null, new DateTime(2020, 1, 1, 9, 10, 30, 0, DateTimeKind.Unspecified) },
                    { new Guid("00000000-0000-0000-0000-000000000002"), true, new DateTime(1985, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 1, 5, 9, 10, 30, 0, DateTimeKind.Unspecified), "admin1@gmail.com", "Admin", "m", "1", "de", "138a", "$2a$11$9hdhZHdGIdgdrvEgmuiebObt2cNrU3r2j1csn/1vSj8Q3wJyu4jyO", null, "53698", new Guid("54a130d2-502f-4cf1-a376-63edeb000001"), null, null, 1, "{}", "Bonnstr.", "mr", null, null, new DateTime(2020, 4, 1, 9, 10, 30, 0, DateTimeKind.Unspecified) },
                    { new Guid("00000000-0000-0000-0000-000000000006"), false, new DateTime(2000, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 1, 7, 9, 10, 30, 0, DateTimeKind.Unspecified), "user1@gmail.com", "User", "m", "1", "de", "137c", "$2a$11$qtabamm1xnMZOB1PkuY4texhEFLlpcJ4O3cyvfF0skMmkdW2jtJti", null, null, new Guid("54a130d2-502f-4cf1-a376-63edeb000002"), null, null, 2, "{}", "Alexstr.", "mr", null, null, null }
                });
